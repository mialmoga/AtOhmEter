...
void main(){
    ...
    for(int i=0;i<128;i++){
        ...
        // Fresnel barato — usa posición como aproximación de normal
        // 0 samples extra vs 6 del criogenico original
        float fr = pow(1.0 - abs(dot(rd, normalize(pos + 0.001))), 3.0);
